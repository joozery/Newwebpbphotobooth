...
+ console.log('Detail images:', detail_images);
...
+           console.log('Old detail images deleted successfully');
...
+           const totalOperations = (features && features.length > 0 ? 1 : 0) + 
+                                 (technicalSpecs && technicalSpecs.length > 0 ? 1 : 0) + 
+                                 (detail_images && detail_images && detail_images.length > 0 ? 1 : 0) + 1; // +1 for always completing
...
+             console.log('No technical specs to insert');
              checkCompletion();
            }
...
+             console.log('Inserting detail images:', detail_images);
...
+             console.log('No detail images to insert (detail_images is null, empty, or not an array)');
              checkCompletion();
            }
          });
        });
